package com.frab.spring.webflux.exception;
...
@Component
@Slf4j
public class GlobalExceptionHaandler extends AbstractErrorWebExceptionHandler {

    public GlobalExceptionHaandler(ErrorAttributes errorAttributes, WebProperties.Resources resources, ApplicationContext applicationContext, ServerCodecConfigurer configurer) {
